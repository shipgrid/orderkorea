...
const HomeContainer = () => {
  ...
  const onRequestCarClick = () => {
    trackFormOpen('Request a Car');
    window.location.href = `https://docs.google.com/forms/d/e/1FAIpQLSerMzC4HWA1nDUwWVCxbwvk5Z2yS9BNjJsWgm3EQWTZnGBbeA/viewform?usp=pp_url&entry.1892265409=${session.username}`;
  }
      ...
      children: (
        <div>
          <Space direction='horizontal'>
            ...
            <Input defaultValue={200000} value={filters.mileage[1]} onChange={(e) => handleFilter(e, 'mileage-max')}/>
          </Space>
          <Slider 
            range 
      ...
      children: (
        <div>
          <Space direction='horizontal'>
            ...
            <Input defaultValue={2000000} value={filters.price[1]} onChange={(e) => handleFilter(e, 'price-max')}/>
          </Space>
          <Slider 
            range 
            value={filters.price}
              ...
              <div className='request-car-card'>
                <div className='request-car-content'>
                  <div>
                    ...
                    <Button type='primary' style={{ width: '100%', height: 45, margin: '12px 0px' }} onClick={onRequestCarClick}>
                      Request a Car
                    </Button>
                  </div>
                </div>
